...
| 5 | Recepcionista IA de doble negocio (Love Fitness presencial + Transforma online en un WhatsApp) | ✅ | **Operativo vía puente Vercel** (`/api/sales/run`). Recepción → detección de negocio → nunca mezcla · gimnasio (clase de prueba horario abierto, cierre lovefitness.es) · online (valoración con hueco + Google Calendar, cierre transformacuerpo.com) · asesor por objetivo · cambio de contexto. E2E real con 556291259429: recepción, gimnasio y online entregados (external_ids reales), enlaces correctos no cruzados. Worker Railway congelado (4-8 jul); al reconstruirlo, volver a la acción nativa `sales_assistant`. |
